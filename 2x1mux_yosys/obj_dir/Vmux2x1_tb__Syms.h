...
#ifndef VERILATED_VMUX2X1_TB__SYMS_H_
#define VERILATED_VMUX2X1_TB__SYMS_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES)Vmux2x1_tb__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    Vmux2x1_tb* const __Vm_modelp;
