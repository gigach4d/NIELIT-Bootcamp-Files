...
#include "Vand_gate_tb___024unit.h"

VL_ATTR_COLD void Vand_gate_tb___024unit___ctor_var_reset(Vand_gate_tb___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vand_gate_tb___024unit___ctor_var_reset\n"); );
