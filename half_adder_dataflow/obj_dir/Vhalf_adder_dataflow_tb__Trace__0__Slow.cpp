...
VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_init_sub__TOP__0(Vhalf_adder_dataflow_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->pushPrefix("half_adder_dataflow_tb", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vhalf_adder_dataflow_tb___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_register(Vhalf_adder_dataflow_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vhalf_adder_dataflow_tb___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vhalf_adder_dataflow_tb___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vhalf_adder_dataflow_tb___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vhalf_adder_dataflow_tb___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder_dataflow_tb___024root__trace_const_0\n"); );
    // Init
...
VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_full_0_sub_0(Vhalf_adder_dataflow_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder_dataflow_tb___024root__trace_full_0\n"); );
    // Init
    Vhalf_adder_dataflow_tb___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vhalf_adder_dataflow_tb___024root*>(voidSelf);
    Vhalf_adder_dataflow_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vhalf_adder_dataflow_tb___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vhalf_adder_dataflow_tb___024root__trace_full_0_sub_0(Vhalf_adder_dataflow_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhalf_adder_dataflow_tb___024root__trace_full_0_sub_0\n"); );
    Vhalf_adder_dataflow_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.half_adder_dataflow_tb__DOT__a));
    bufp->fullBit(oldp+2,(vlSelfRef.half_adder_dataflow_tb__DOT__b));
    bufp->fullBit(oldp+3,(((IData)(vlSelfRef.half_adder_dataflow_tb__DOT__a) 
                           ^ (IData)(vlSelfRef.half_adder_dataflow_tb__DOT__b))));
    bufp->fullBit(oldp+4,(((IData)(vlSelfRef.half_adder_dataflow_tb__DOT__a) 
                           & (IData)(vlSelfRef.half_adder_dataflow_tb__DOT__b))));
}
