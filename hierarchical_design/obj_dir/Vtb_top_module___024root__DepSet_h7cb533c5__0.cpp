...
VlCoroutine Vtb_top_module___024root___eval_initial__TOP__Vtiming__0(Vtb_top_module___024root* vlSelf);
VlCoroutine Vtb_top_module___024root___eval_initial__TOP__Vtiming__1(Vtb_top_module___024root* vlSelf);
...
void Vtb_top_module___024root___eval_initial(Vtb_top_module___024root* vlSelf) {
    ...
    // Body
    Vtb_top_module___024root___eval_initial__TOP__Vtiming__0(vlSelf);
    Vtb_top_module___024root___eval_initial__TOP__Vtiming__1(vlSelf);
}
...
void Vtb_top_module___024root___nba_sequent__TOP__0(Vtb_top_module___024root* vlSelf);
...
VL_INLINE_OPT void Vtb_top_module___024root___nba_sequent__TOP__0(Vtb_top_module___024root* vlSelf) {
    ...
    // Body
    __Vdly__tb_top_module__DOT__dut__DOT__count = vlSelfRef.tb_top_module__DOT__dut__DOT__count;
    if (vlSelfRef.tb_top_module__DOT__rst) {
        __Vdly__tb_top_module__DOT__dut__DOT__count = 0U;
    } else if (vlSelfRef.tb_top_module__DOT__en) {
        __Vdly__tb_top_module__DOT__dut__DOT__count 
            = (0xffU & ((IData)(1U) + (IData)(vlSelfRef.tb_top_module__DOT__dut__DOT__count)));
    }
    vlSelfRef.tb_top_module__DOT__dut__DOT__count = __Vdly__tb_top_module__DOT__dut__DOT__count;
}
...
bool Vtb_top_module___024root___eval_phase__act(Vtb_top_module___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_top_module___024root___eval_phase__act\n"); );
    Vtb_top_module__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vtb_top_module___024root___eval_phase__nba(Vtb_top_module___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_top_module___024root___eval_phase__nba\n"); );
    Vtb_top_module__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
void Vtb_top_module___024root___eval(Vtb_top_module___024root* vlSelf) {
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelfRef.__VactContinue) {
            ...
            if (Vtb_top_module___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vtb_top_module___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
