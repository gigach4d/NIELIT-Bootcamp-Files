...
void Vtb___024root__trace_chg_0_sub_0(Vtb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+2,(vlSelfRef.tb__DOT__cnt_async),4);
    bufp->chgCData(oldp+3,(vlSelfRef.tb__DOT__cnt_sync),4);
    bufp->chgBit(oldp+4,(vlSelfRef.tb__DOT__rst_sync));
    bufp->chgBit(oldp+5,(vlSelfRef.tb__DOT__u_sync__DOT__stage1));
}
