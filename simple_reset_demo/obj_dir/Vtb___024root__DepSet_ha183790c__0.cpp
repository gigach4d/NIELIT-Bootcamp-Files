...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__0(Vtb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb__DOT__cnt_async = ((IData)(vlSelfRef.tb__DOT__rst)
                                     ? 0U : (0xfU & 
                                             ((IData)(1U) 
                                              + (IData)(vlSelfRef.tb__DOT__cnt_async))));
}
...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__1(Vtb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb__DOT__cnt_sync = ((IData)(vlSelfRef.tb__DOT__rst_sync)
                                    ? 0U : (0xfU & 
                                            ((IData)(1U) 
                                             + (IData)(vlSelfRef.tb__DOT__cnt_sync))));
}
...
VL_INLINE_OPT void Vtb___024root___nba_sequent__TOP__2(Vtb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb__DOT__rst_sync = ((IData)(vlSelfRef.tb__DOT__rst) 
                                   || (IData)(vlSelfRef.tb__DOT__u_sync__DOT__stage1));
    vlSelfRef.tb__DOT__u_sync__DOT__stage1 = vlSelfRef.tb__DOT__rst;
}
